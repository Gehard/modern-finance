			...
			<div class="col-md-4 col-md-offset-4">
				<form role="form">
					...
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=model.getAccount_no() %>" required placeholder="Enter Account No.."
							class="form-control">
					</div>
					<label class="col-md-4 control-label">User Name</label>
					<div class="col-sm-8 form-group">
						<input type="text" value="<%=model.getUsername() %>" required placeholder="Enter User Name.."
							class="form-control">
					</div>
