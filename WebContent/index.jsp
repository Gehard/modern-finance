		...
		<div class="row">
			<div class="schemes" style="margin-bottom: -155px;">
				<div class="col-md-4 scheme-type-1">
					...
					<p class="col-md-6 col-md-offset-3 text-center scheme-text">Access
						Instant loans Loans 
					.</p>
				...
				<div class="col-md-4 scheme-type-2">
					...
					<p class="col-md-6 col-md-offset-3 text-center scheme-text">Get 
					a variety of Deposit Scheme
						</p>
					<div class="scheme-button col-md-4 col-md-offset-4">
				...
				<div class="col-md-4 scheme-type-3">
					...
					<p class="col-md-6 col-md-offset-3 text-center scheme-text">A
					simple walk through on how to use Modern Finance system
					
					
						</p>
					<div class="scheme-button col-md-4 col-md-offset-4">
						<a type="button" class="btn btn-default btn-lg"
							href= "Modern Finance Help/index.html" style="border-radius: 24px;" target="Modern Finance Help/index.html">Learn more..</a>
					</div>
				</div>
			</div>
		</div>
