		...
		<div class="row" style="margin-top: 50px;">
			<div class="col-md-4 col-md-offset-4">
				<form role="form" method="post" action="TransferServlet">
					...
					<label class="col-md-4 control-label">Beneficiary's Full Name</label>
					<div class="col-sm-8 form-group">
						<input type="text" required placeholder="Enter Beneficiary's Name.."
							name="target_acc_no" class="form-control">
					</div>
					
					
					<label class="col-md-4 control-label">Beneficiary's Branch</label>
						<div class="col-sm-8 form-group">
					...
					<label class="col-md-4 control-label">Beneficiary's Postal Code</label>
					<div class="col-sm-8 form-group">
						<input type="text" required placeholder="Enter Postal Code.."
							name="target_acc_no" class="form-control">
					</div>
					
						<label class="col-md-4 control-label">Purpose of payment</label>
					<div class="col-sm-8 form-group">
					...
					<label class="col-md-4 control-label">Currency Being Remitted</label>
						<div class="col-sm-8 form-group">
